...
public class GetTransStatisticByMonthSteps {
    ...
    public Response getTransStatisticByMonth(Merchant merchant, String language){

        String body = createBody(merchant);

        String getPath = MerchantSolutionURL.getTransStatisticByMonthPath + "?language=" + language;
    ...
    @Step
    public void beAbleToGetTransStatisticByMonth(Merchant merchant, String language) {

        Response response = getTransStatisticByMonth(merchant,language);
    ...
    @Step
    public void noDataWhenGetTransStatisticByMonth(Merchant merchant, String language) {
